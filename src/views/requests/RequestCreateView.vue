...
<template>
  <section class="form-page">
    ...
    <form class="card request-form" @submit.prevent="submit">
      <label class="field"><span>Machine / Asset ID <b>*</b></span><span class="input-with-icon"><Search :size="19" /><input v-model.trim="machineId" minlength="2" maxlength="100" placeholder="Search or enter Asset ID (e.g., MCH-402)" required /></span><small>Select the specific equipment requiring attention.</small></label>
      <label class="field"><span>Problem Description <b>*</b></span><textarea v-model.trim="problem" minlength="10" maxlength="500" placeholder="Describe the issue, symptoms, and any error codes..." required /><small class="field__helper">Be as detailed as possible to assist technicians. Minimum 10 characters.<em>{{ problem.length }}/500</em></small></label>
